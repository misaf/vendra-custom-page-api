...
final class CustomPageCategorySchema extends Schema
{
    public static string $model = CustomPageCategory::class;
    ...
    {
        return [
            Has::make($this, 'customPages', 'has-custom-pages'),
            WhereHas::make($this, 'customPages', 'with-custom-pages'),
            WhereDoesntHave::make($this, 'customPages', 'without-custom-pages'),
