...
final class CustomPageCategoryCollectionQuery extends ResourceQuery
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'filter.has-custom-pages'       => JsonApiRule::boolean()->asString(),
            'filter.with-custom-pages'      => 'array',
            'filter.with-custom-pages.*'    => 'string',
            'filter.without-custom-pages'   => 'array',
            'filter.without-custom-pages.*' => 'string',
            'include'                       => [
                'nullable',
                'string',
